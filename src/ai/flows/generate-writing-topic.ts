...
const ChartDataSchema = z.object({
    ...
    data: z.array(z.object({ _placeholder: z.any().optional() }).passthrough()).describe('The data for the chart, as an array of objects. For example, for a bar chart: [{ "month": "Jan", "sales": 100 }, { "month": "Feb", "sales": 150 }]'),
    config: z.object({
